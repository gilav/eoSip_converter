...
class eop_processing(SipMessageBuilder):
    ...
    REPRESENTATION = ["<eop:ProcessingInformation>@ProcessingInformation@</eop:ProcessingInformation>",
                      "<eop:processingMode>@processingMode@</eop:processingMode>"]

    FIELDS = ["ProcessingInformation", "processingMode"]

    MANDATORY = ["ProcessingInformation", "processingMode"]
