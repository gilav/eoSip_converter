...
EOSIP_METADATA_MAPPING={'responsible':metadata.METADATA_RESPONSIBLE, 'reportType':metadata.METADATA_REPORT_TYPE, 'generationTime':metadata.METADATA_GENERATION_TIME,
                        'gmlId':metadata.METADATA_PRODUCTNAME, 'identifier':metadata.METADATA_PRODUCTNAME, 'parentIdentifier':metadata.METADATA_PRODUCTNAME,
                        'productType':metadata.METADATA_TYPECODE,
                        'beginPositionDate':metadata.METADATA_START_DATE, 'beginPositionTime':metadata.METADATA_START_TIME,
                        'endPositionDate':metadata.METADATA_STOP_DATE, 'endPositionTime':metadata.METADATA_STOP_TIME,
                        'platformShortName':metadata.METADATA_PLATFORM, 'platformSerialIdentifier':metadata.METADATA_PLATFORM_ID,
                        ...
                        'browseImageType':browse_metadata.BROWSE_METADATA_IMAGE_TYPE, 'browseIdentifier':browse_metadata.BROWSE_METADATA_FILENAME, 'browseFileName':browse_metadata.BROWSE_METADATA_NAME,
